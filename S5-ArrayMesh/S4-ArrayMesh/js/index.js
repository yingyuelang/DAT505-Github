...
function init() {
  ...
  for (var x = -25; x <= 30; x +=5) { // Start from -45 and sequentially add one every 5 pixels
    for (var y = -25; y <=30; y += 5) {
...
//cubes[18].rotation.x += randomSpeedX[0];
//cubes[8].rotation.z += randomSpeedX[0];
//c.scale.z +=0.03;
